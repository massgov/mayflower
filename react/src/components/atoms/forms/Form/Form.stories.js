...
storiesOf('atoms/forms', module)
  ...
  .add(
    'Form', (() => {
      const Form = lazy(() => import('./index'));
      const FormProvider = lazy(() => import('./storyimports'));
      const InputNumber = lazy(() => import('../InputNumber'));
      const InputSlider = lazy(() => import('../InputSlider'));
      const InputCurrency = lazy(() => import('../InputCurrency'));
