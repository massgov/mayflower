  ...
  .add(
    ...
    `)(() => {
      ...
      const defaultStartDate = {
        labelText: 'Select a start date', required: false, id: 'start-date', name: 'start-date', placeholder: 'today', restrict: 'min'
      };
      const startDate = object('startDate', defaultStartDate);

      const defaultEndDate = {
        labelText: 'Select an end date', required: false, id: 'end-date', name: 'end-date', placeholder: 'mm/dd/yy', restrict: 'min'
      };
