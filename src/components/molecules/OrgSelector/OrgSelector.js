...
class OrgSelector extends React.Component {
  ...
  renderOrgData (selectedIndex, selected, selectedValue) {
    if(selectedValue){
      OrgInfo(this.props.organizations[selectedIndex])
    }
  }
                ...
                <div className="ma__org-info__link">
                  <span className="ma__decorative-link">
                    <a 
                      ...
                      aria-label={org.moreLink.info}>{org.moreLink.text}&nbsp;<svg aria-hidden="true" id="SvgjsSvg1000" xmlns="http://www.w3.org/2000/svg" version="1.1" width="16" height="18" viewBox="0 0 16 18"><defs id="SvgjsDefs1001"></defs><path id="SvgjsPath1007" d="M983.721 1887.28L983.721 1887.28L986.423 1890L986.423 1890L986.423 1890L983.721 1892.72L983.721 1892.72L978.318 1898.17L975.617 1895.45L979.115 1891.92L971.443 1891.92L971.443 1888.0700000000002L979.103 1888.0700000000002L975.617 1884.5500000000002L978.318 1881.8300000000002Z " transform="matrix(1,0,0,1,-971,-1881)"></path></svg></a>
                  </span>
                </div>
            )}
        </div>
