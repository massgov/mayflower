// NOTE: THIS ONE IS GOING TO MERGE WITH mainNavHamburger.js MOST PART.
//       DISABLED TO AVOID THIS AFFECTS THE OTHER ONE WHILE DEVELOPMENT.

// const body = document.querySelector("body");
// let width = body.clientWidth;
// const menuButton = document.querySelector(".ma__header__mixed .js-header-menu-button");
// let menuButtonText = document.querySelector('.ma__header__mixed .js-header__menu-text');
// let buttonLabel;
// const feedbackButton = document.querySelector('.ma__fixed-feedback-button');
// const mainMenu = document.querySelector('.ma__header__mixed .js-main-nav-hamburger');
// let menuItems = document.querySelectorAll('.ma__header__mixed .js-main-nav-hamburger-toggle');
// const menuOverlay = document.querySelector('.menu-overlay');
// const searchForm = document.querySelector(".ma__header__mixed .js-header-search-menu .js-header-search-form");
// let utilNavWide = document.querySelector('.ma__header__mixed .js-utility-nav--wide');
...
//     if (e.code == 'Tab') {
//       e.preventDefault();
//       document.querySelector('.ma__header__mixed-search__input').focus();
//     }
