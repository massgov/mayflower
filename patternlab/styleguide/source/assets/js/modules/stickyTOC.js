export default (function (window,document,$,undefined) {
  ...
  $('.pre-content .ma__sticky-toc').each(function() {
    const $toc = $('.ma__sticky-toc'),
          ...
          $tocSections = $('.ma__information-details .page-content, .ma__stacked-row-section__container .ma__stacked-row-section__title, .ma__stacked-row__container .ma__stacked-row__title').find('h2'),
