...
| --- | --- |
| mg\_organization | Controls the ability to filter content by organization on search.mass.gov. | ![Example Screenshot of the Organization Filter](../.gitbook/assets/advanced-search-collapsed%20%281%29.png) |
...
| --- | --- |
| mg\_date | Used when sorting by date on the "news" and "laws-regulations" tabs. | ![Example Screenshot of Sort by Date Functionality](https://github.com/massgov/mayflower/tree/1494615c6c7b6adefa48e670af18f49e8a05e8d6/docs/assets/mg_date.png.png) |
