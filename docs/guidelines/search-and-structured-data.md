...
| --- | --- |
| mg\_date | Used when sorting by date on the "news" and "laws-regulations" tabs. | ![Example Screenshot of Sort by Date Functionality](https://github.com/massgov/mayflower/tree/b9bfcac887039119d151c9aa3cbfd81a1a0b255d/docs/assets/mg_date.png.png) |
...
| mg\_online\_contact\_url | Rendered in teaser for content categorized as "state-organizations" | ![Example Results Teaser with the Online Contacts Rendered](../.gitbook/assets/mg_phone_number%20%283%29.png) |
