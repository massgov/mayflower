...
{% tab title="Example" %}
![](../../.gitbook/assets/form_helper_text.png)
{% endtab %}
...
http://mass.gov/framework/helpertext.sketch
{% endtab %}
...
{% tab title="Design" %}
![](../../.gitbook/assets/form_input_checkbox.png)
{% endtab %}
...
{% tab title="Design" %}
![](../../.gitbook/assets/form_text_input_optional.png)
{% endtab %}
