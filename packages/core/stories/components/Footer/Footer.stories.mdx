...
<Canvas>
  ...
  <Story
    name="footer-slim-css"
    parameters={{ docs: { source: {code: '// Link to CSS: <link rel="stylesheet" href="https://unpkg.com/@massds/mayflower-assets@[version]/css/footer-slim.css">'} } }} />
</Canvas>
