...
### Header (Slimmest)
A most simplified version of a header contains a blue bar (height: 15px) at the top and a site logo and site name linked to the home of the website, placed on a light gray background (var(--mf-c-gray-lightest))
<Canvas>
