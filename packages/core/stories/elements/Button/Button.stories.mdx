...
- **Style:** Default buttons are solid color with contrasting uppercase text. For actions with text longer than two words use the title case instead of all caps. On hover, the Background color becomes lighter.
