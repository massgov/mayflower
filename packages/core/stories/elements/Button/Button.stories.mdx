...
- **Style:** The gray color is even less prominent than outline button to de-emphasize third-level tasks. The hover state lightens the primary button background color.
