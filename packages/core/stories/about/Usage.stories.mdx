...
<h1>Get Started with Mayflower <small>version {process.env.STORYBOOK_VERSION}</small></h1>
...
- To import fonts and get started with basic Mayflower styles, link to the compiled `css/global.css` (or the minified version, `css/global.min.css`) from the @massds/mayflower-assets package or the assets CDN.
    > <code>{`${process.env.STORYBOOK_CDN_PATH}/css/global.css`}</code>
...
- To include basic page layout styles from Mayflower, link to the compiled `css/layout.css` (or the minified version, `css/layout.min.css`) from the @massds/mayflower-assets package or the assets CDN.
    > <code>{`${process.env.STORYBOOK_CDN_PATH}/css/layout.css`}</code>
...
If you are not using NPM, you can also directly <a href={`https://registry.npmjs.org/${process.env.STORYBOOK_PKG}/-/mayflower-assets-${process.env.STORYBOOK_VERSION}.tgz`}>download a compressed package for the latest version</a>, or specify a version in the URL:
<pre>
  <code>
  {`https://registry.npmjs.org/${process.env.STORYBOOK_PKG}/-/mayflower-assets-[version].tgz`}
  </code>
</pre>
...
<a href={`${process.env.STORYBOOK_CDN}browse/${process.env.STORYBOOK_PKG}/`}>{`${process.env.STORYBOOK_CDN}browse/${process.env.STORYBOOK_PKG}/`}</a>
  ...
  <tr>
    ...
    <td>
      <ul style={{listStyle: 'none'}}>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/static/images/logo/stateseal.png`}</li>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/static/images/logo/stateseal.svg`}</li>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/static/images/logo/stateseal-color.svg`}</li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul style={{listStyle: 'none'}}>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/static/fonts/noto/Latin/NotoSans-Regular.woff2`}</li>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/static/fonts/noto/Latin/NotoSans-Italic.woff2`}</li>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/static/fonts/noto/Latin/NotoSans-VF.woff2`}</li>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/static/fonts/noto/Latin/NotoSansItalic-VF.woff2`}</li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul style={{listStyle: 'none'}}>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/css/global.css`}</li>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/css/global.min.css`}</li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul style={{listStyle: 'none'}}>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/css/header.css`}</li>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/css/header.min.css`}</li>
      </ul>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <ul style={{listStyle: 'none'}}>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/js/header.js`}</li>
        <li>{`${process.env.STORYBOOK_CDN_PATH}/js/header.min.js`}</li>
      </ul>
    </td>
  </tr>
</table>
