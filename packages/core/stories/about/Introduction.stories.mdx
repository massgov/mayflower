...
<p>
  Read more below for in-depth information about the stystem, go to
  {' '}
  <StoryLink metaID="Usage" inline /> to dive right in and start using Mayflower or got to <StoryLink metaID="Examples" inline /> for some guidance on what you can build with Mayflower along with real world projects.
	{' '}
</p>
