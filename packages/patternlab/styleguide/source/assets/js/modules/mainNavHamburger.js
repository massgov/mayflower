...
if (hamburgerMenuContainer) {
  ...
  if (menuButton !== null) {
    ...
    const logoLink = document.querySelector(
      ".ma__header__hamburger__nav-container .ma__header__hamburger__logo--mobile a"
    );
    if (logoLink) {
      menuButton.addEventListener("keydown", function (e) {
        if (
          (e.key === "Tab" && !(e.shiftKey && e.key === "Tab")) ||
          (e.code === "Tab" && !(e.shiftKey && e.code === "Tab"))
        ) {
    ...
    document.addEventListener("keydown", function (e) {
      ...
      if (e.key === "Escape" || e.key === "Esc" || e.code === "Escape") {
        ...
        if (
          utilNavWide.querySelector(".js-util-nav-content").style.opacity ===
          "1"
        ) {
        ...
        if (!openTopMenuUnit || openSubmenu !== document.activeElement) {
          ...
          let openSubmenuItems = document.querySelectorAll(
            ".submenu-open .js-main-nav-hamburger-content:not(is-closed) .js-main-nav-hamburger__link"
          );
          for (let i = 0; i < openSubmenuItems.length; i++) {
            if (openSubmenuItems[i] === document.activeElement) {
              ...
              openTopMenuUnit
                .querySelector(".js-main-nav-hamburger__top-link")
                .setAttribute("aria-expanded", "false");
              openTopMenuUnit.style.pointerEvents = "none";
              /** Slide up. */
              openTopMenuUnit.querySelector(
                ".js-main-nav-hamburger-content"
              ).style.height = "0";
              openTopMenuUnit.querySelector(
                ".js-main-nav-hamburger__container"
              ).style.opacity = "0";
              setTimeout(function timeoutFunction() {
    ...
    let submenuLinks = document.querySelectorAll(
      ".js-main-nav-hamburger__link"
    );
  ...
  function commonCloseMenuTasks() {
    ...
    if (document.querySelector("html.stickyTOCtmp")) {
      ...
      document
        .querySelector("html.stickyTOCtmp")
  ...
  function openMenu() {
    ...
    let lockPage = function () {
      ...
      heightAboveMenuContainer =
        hamburgerMenuContainer.getBoundingClientRect().top;
    };
  ...
  function anotherCloseSubMenus(item) {
    menuItems.forEach((li) => {
      if (item !== li && li.classList.contains("submenu-open")) {
        ...
        li.querySelector(".js-main-nav-hamburger__top-link").setAttribute(
          "aria-expanded",
          "false"
        );
        ...
        li.querySelector(".js-main-nav-hamburger__container").style.opacity =
          "0";
        setTimeout(function timeoutFunction() {
          li.removeAttribute("style");
          li.querySelector(".js-main-nav-hamburger-content").classList.add(
            "is-closed"
          );
        }, 500);
      }
  ...
  function closeSubMenu() {
    ...
    if (openSubMenu) {
      let openSubMenuButton = openSubMenu.querySelector(
        ".js-main-nav-hamburger__top-link"
      );
      let openSubMenuContent = openSubMenu.querySelector(
        ".js-main-nav-hamburger-content"
      );
      let openSubMenuContainer = openSubMenu.querySelector(
        ".js-main-nav-hamburger__container"
      );
  ...
  menuItems.forEach((item) => {
    ...
    itemButton.addEventListener("keydown", function (e) {
      if (e.key === "ArrowDown" || e.code === "ArrowDown") {
        ...
        e.target
          .closest(".js-main-nav-hamburger-toggle")
          .querySelector(
            ".js-main-nav-hamburger__subitem:first-child .js-main-nav-hamburger__link"
          )
          .focus();
      }
      ...
      if (e.key === "ArrowUp" || e.code === "ArrowUp") {
        ...
        e.target
          .closest(".js-main-nav-hamburger-toggle")
          .querySelector(
            ".js-main-nav-hamburger__subitem:last-child .js-main-nav-hamburger__link"
          )
          .focus();
      }
    });
    ...
    function expandSubMenuContainer() {
      ...
      if (
        ...
        const height =
          item.querySelector(".js-main-nav-hamburger-content").clientHeight +
          "px";
  ...
  function selectTopClickableItems(windowWidth) {
    ...
    if (windowWidth > 840) {
      topLevelClickableItems = hamburgerMenuContainer.querySelectorAll(
        ".ma__header__hamburger__main-nav .ma__main__hamburger-nav__top-link"
      );
    }
    if (windowWidth < 841) {
      topLevelClickableItems = hamburgerMenuContainer.querySelectorAll(
  ...
  setTimeout(function timeoutFunction() {
    // This prevents GT elements get null.
    let gTranslateButtons = document.querySelectorAll(
      ".ma__utility-nav__translate #google_translate_element a"
    );
    ...
    // if (utilNarrowNav) {
    //   let hamburgerGTSymbol = utilNarrowNav.querySelector(".ma__utility-nav__translate #google_translate_element a span:nth-of-type(3)");
    ...
    if (gTranslateOptionContainer) {
      gTranslateOptionContainer.contentWindow.document.addEventListener(
        ...
        (e) => {
          ...
          let firstGTOption =
            gTranslateOptionContainer.contentWindow.document.querySelector(
              "a.goog-te-menu2-item-selected"
            );
          let lastGTOption =
            gTranslateOptionContainer.contentWindow.document.querySelector(
              "td:last-child a.goog-te-menu2-item:last-child"
            );
          let currentFocusInIframe =
            gTranslateOptionContainer.contentWindow.document.activeElement;

          // Set focus on the menu button when SHIFT + TAB are hit on the first Google Translate focusable element.
          if (
            currentFocusInIframe === firstGTOption &&
            e.shiftKey &&
            key === "Tab"
          ) {
            e.preventDefault();
